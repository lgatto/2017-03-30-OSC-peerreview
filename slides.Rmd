---
title: 'The role of peer-reviewer in checking supporting information'
...
## The role of peer-reviewer in checking ~~supporting information~~ what matters
...
* Accept sound/valid research
* Provide constuctive comments
...
- As a reviewer, I commit to make a /reasonable effort/ to find the
  ...
  any issues, ...
- I also know my strengths and weaknesses, and will react
  accordingly. For example, I consider myself reasonably well skilled
  in computational literacy. If I struggle to install and run the
...
- Molecular biology is not a strength, and I will have to either read
  some background, or acknowledge it explicitly.
...
## Low-hanging fruits (1): availability
...
## Low-hanging fruits (2): do numbers match

* Experimental design: 2 groups, 3 replicates, but 
* Files: Not a mulitple of 6!

## Low-hanging fruits (3): meta-data

No need to necessarily repeat everything.

But if I wanted to repeat the analysis, would I be able? Is something
missing? What?

Tip: Document everything in a `REAMDE` file.

## Low-hanging fruits (4): what data, what format
...
- A paper describing the software
...
NB: There is no perfect solution, hence often a combination of the
above is great.
